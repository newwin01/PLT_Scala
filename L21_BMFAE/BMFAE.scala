...
/*
  ...
  println(run("{with {q {newbox 10}} {setbox {seqn {setbox q 12} q} {openbox q}}}", MtSub, MtSto))

  println(run("{with {x 3} x}", MtSub, MtSto))
  println(run("{with {x {fun {x} x}} x}", MtSub, MtSto))
  ...
  println(run("{with {b {newbox 7}} {seqn {openbox b} {openbox b}}}", MtSub, MtSto))
  println(run("{with {b {newbox 7}} {seqn {setbox b 10} {openbox b}}}", MtSub, MtSto))
  println(run("{with {x 7} x}", MtSub, MtSto))
*/
  //println(run("{with {b {newbox 7}} {seqn {setbox b 10} {openbox b}}}", MtSub, MtSto))
